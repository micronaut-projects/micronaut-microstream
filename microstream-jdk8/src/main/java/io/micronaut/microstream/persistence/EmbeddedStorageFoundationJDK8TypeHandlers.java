...
/**
 * Listens for the creation of {@link EmbeddedStorageFoundation} instances, and binds the JDK8 binary handlers to them.
 *
 * @author Tim Yates
 * @since 1.0.0
 */
@Singleton
@Requires(bean = EmbeddedStorageFoundationJDK8ConfigurationProperties.class)
