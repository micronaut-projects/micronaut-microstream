...
@Property(name = "spec.name", value = "StoreAllFuncSpec")
class StoreAllFuncSpec extends Specification implements TestPropertyProvider {
    ...
    void "no name specified results in an exception"() {
        ...
        and:
        1 * mockStorageManager.storeAll(_) >> [1L]
    }
    ...
    @Singleton
    @Requires(property = "spec.name", value = "StoreAllFuncSpec")
