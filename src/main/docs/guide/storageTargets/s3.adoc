Configuration of an https://docs.eclipsestore.io/manual/storage/storage-targets/blob-stores/aws-s3.html[S3 storage target] requires a bean of type `S3Client` and configuration.
