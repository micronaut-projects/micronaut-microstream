...
To use the Micronaut cache annotations, you need to declare a dependency on the Micronaut cache module:

dependency:micronaut-cache-core[group="io.micronaut.cache"]
