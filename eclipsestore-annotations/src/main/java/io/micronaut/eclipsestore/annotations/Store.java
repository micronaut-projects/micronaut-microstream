 ...
 * </pre>
 *
 * @see <a href="https://docs.eclipsestore.io/manual/storage/root-instances.html#_shared_mutable_data">EclipseStore mutable data docs.</a>
 * @since 1.0.0
 * @author Tim Yates
...
public @interface Store {
     ...
     * If your application only have a EclipseStore instance, this is not required
     *
